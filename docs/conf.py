...
latex_documents = [
    (master_doc, 'dragonfly-radiance.tex', 'dragonfly-radiance Documentation',
...
man_pages = [
    (master_doc, 'dragonfly-radiance', 'dragonfly-radiance Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'dragonfly-radiance', 'dragonfly-radiance Documentation',
     author, 'dragonfly-radiance', 'One line description of project.',
     'Miscellaneous'),
]
...
def write_cli_files(group_filenames, lib_name, tool_name, doc_folder):
    ...
    Args:
        ...
        lib_name: The name of the library the click groups belong to. For
            example ``honeybee_radiance``, ``dragonfly`` or ``honeybee_radiance``
            are possible library names.
        tool_name: The command line tool name for the specified library. For
            instance ``honeybee-radiance`` is the CLI tool used for the
            honeybee_radiance library.
